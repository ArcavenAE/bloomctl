//! xtask — developer commands for the bloomctl workspace.
//!
...
//!   * `regen`      — run progenitor against vendored spec, write bloomctl-api
...
#[derive(Parser, Debug)]
#[command(name = "xtask", about = "Developer tasks for bloomctl")]
struct Cli {
    #[command(subcommand)]
    cmd: Cmd,
}
...
enum Cmd {
    ...
    SyncSpec,
    /// Regenerate bloomctl-api from the vendored spec. Not yet implemented.
    Regen,
...
const GENERATED_REL_PATH: &str = "crates/bloomctl-api/src/generated.rs";
